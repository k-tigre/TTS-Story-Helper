...
object AiMarkupApi {
    ...
    private const val SYSTEM_PROMPT = """Ты помощник для разметки текста голосами.
Тебе дают текст, и ты должен разметить его тегами голосов в формате [имя_голоса]текст[/имя_голоса].
Используй осмысленные имена голосов, например: narrator, character1, character2 и т.д.
Верни ТОЛЬКО размеченный текст, без пояснений."""
